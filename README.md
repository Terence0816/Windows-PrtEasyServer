...
[![v1.0.0.0 Downloads](https://img.shields.io/github/downloads/Terence0816/Windows-PrtEasyServer/v1.0.0.0/total?label=v1.0.0.0%20Downloads&color=cf222e)](https://github.com/Terence0816/Windows-PrtEasyServer/releases/tag/v1.0.0.0)
...
- Official `v1.0.0.0` download: [PrtEasyServer.exe](https://github.com/Terence0816/Windows-PrtEasyServer/releases/download/v1.0.0.0/PrtEasyServer.exe)
...
- 正式版 `v1.0.0.0`：[PrtEasyServer.exe](https://github.com/Terence0816/Windows-PrtEasyServer/releases/download/v1.0.0.0/PrtEasyServer.exe)
